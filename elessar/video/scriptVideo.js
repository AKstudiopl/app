...
function userSource(){
    let videoUserSource = document.querySelector(".user_source input").value;
    document.querySelector(".user_source").classList.add("active");

    setTimeout(() => {
        document.querySelector(".user_source").remove();
      }, "1000")
